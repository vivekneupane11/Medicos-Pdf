            ...
            <div className="termsAndConditions">
                <div className="termsAndConditions-content">
                    ...
                    <p>AGREEMENT</p>
                       ...
                       <div>
                            <h2 className="termsAndConditions-content-heading">Terms And Conditions</h2>
                            <p>
                                Welcome to Medicos Pdf!
                                <br/>
                                <br/>
                                By using this app we assume you accept these terms and conditions. Do not continue to use Medicos Pdf if you do not agree to take all of the terms and conditions stated on this page.
                                <br/>
                                <br/>
                      ...
                      <div>
                            <h3 className="h3">Licence</h3>
                            <p>
                            Unless otherwise stated, Medicos Pdf and/or its licensors own the intellectual property rights for all material on Medicos Pdf. All intellectual property rights are reserved. You may access this from Medicos Pdf for your own personal use subjected to restrictions set in these terms and conditions.
                            <br/>
                            </p>
                            <p>You must not:</p>
                            <ul className='ul'>
                                <li>Republish material from Medicos Pdf</li>
                                <li>Sell, rent or sub-license material from Medicos Pdf</li>
                                <li>Reproduce, duplicate or copy material from Medicos Pdf</li>
                                <li>Redistribute content from Medicos Pdf</li>
                            </ul>
                            <p>
                            This Agreement shall begin on the date hereof.
                            <br/>
                            Parts of this app offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Medicos Pdf does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Medicos Pdf, its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Medicos Pdf shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
                            <br/>
                            Medicos Pdf reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
                            <br/>
                            </p>
                            ...
                            <p>
                            You hereby grant Medicos Pdf a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
                            </p>
                                
                      </div>  

                      <div>
                          <h3 className="h3">Hyperlinking to our App</h3>
                          ...
                          <ol type='a' className='ol'>
                              ...
                              <li>the benefit to us from the visibility of the hyperlink compensates the absence of Medicos Pdf; and </li>
                          ...
                          <br/>
                          If you are one of the organizations listed in paragraph 2 above and are interested in linking to our App, you must inform us by sending an e-mail to Medicos Pdf. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our App, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.
                          ...
                          <p>No use of Medicos Pdf's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
                      </div>

                      <div>
                          <h3 className="h3">iFrames</h3>
                      ...
                      <div>
                          <h3 className="h3">Removal of links from our App</h3>
                          <p>
